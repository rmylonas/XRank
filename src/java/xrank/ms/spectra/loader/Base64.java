...
public class Base64 {
	 ...
	 * @since 1.3
	 */
	private final static byte[] encode3to4(byte[] source, int srcOffset,
	 ...
	 * Base64 characters. Of course you probably only need to encode a string if
	 * there are non-ASCII characters in it such as many non-English languages.
	 * 
	 * @param s
	 ...
	 * @return The encoded/decoded file or <tt>null</tt> if there was an
	 *         error.
	 * @since 1.4
	 */
	...
	/**
	 * Writes a byte array to a file either encoding it or decoding it as
	 * specified.
	 * 
	 * @param data
	 ...
	 * @since 1.4
	 */
	public static boolean writeFile(byte[] data, java.io.File file,
			boolean encode) {
	 ...
	 *            The array to write to a file.
	 * @param offset
	 *            The offset where the "real" data begins.
	 * @param length
	...
	public static boolean writeFile(byte[] data, int offset, int length,
		...
		try {
			bos = new Base64.OutputStream(new java.io.BufferedOutputStream(
	...
	/**
	 * Simple helper method that Base64-encodes a file and returns the encoded
	 * string or <tt>null</tt> if there was an error.
	 * 
	 * @param rawfile
	 *            The file to read
	...
	/**
	 * Simple helper method that Base64-decodes a file and returns the decoded
	 * data or <tt>null</tt> if there was an error.
	 * 
	 * @param encfile
	 *            The file to read
